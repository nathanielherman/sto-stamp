...
def printfmt_int(header, out, precision, width):
    ...
    return string
def print_(precision, width, i, seq_time, stm_time, stm_min, stm_max, gen_time, gen_min, gen_max):
    string = ""
    string += "{'seq' : "
...
if __name__ == "__main__":
    ...
    for cmd in cmds:
        ...
        out_file.write(print_(4, 8, 0, seq_time, stm_time, stm_min, stm_max, gen_time, gen_min, gen_max))
        out_file.write(print_(4, 8, 1, seq_time, stm_time, stm_min, stm_max,  gen_time, gen_min, gen_max))
